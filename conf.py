...
BLOG_AUTHOR = "Quan Tran"  # (translatable)
...
FAVICONS = (
    ...
    ("icon", "/images/tab_img.png", "128x128"),
)
...
<span class="fa-stack fa-2x">
  <a href="https://twitter.com/therealquantran">
    <i class="fa fa-circle fa-stack-2x"></i>
    <i class="fa fa-twitter fa-inverse fa-stack-1x"></i>
  </a>
</span>
<span class="fa-stack fa-2x">
  <a href="https://www.linkedin.com/in/anhquan0412">
    <i class="fa fa-circle fa-stack-2x"></i>
...
# is in the manual.
COMMENT_SYSTEM_ID = "quantran-xyz"
